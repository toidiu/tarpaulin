...
fn get_line_addresses(endian: RunTimeEndian,
    ...
    let debug_info = obj.section_data_by_name(".debug_info").unwrap();
    let debug_info = DebugInfo::new(&debug_info, endian);
    let debug_abbrev = obj.section_data_by_name(".debug_abbrev").unwrap();
    let debug_abbrev = DebugAbbrev::new(&debug_abbrev, endian);
    let debug_strings = obj.section_data_by_name(".debug_str").unwrap();
    let debug_strings = DebugStr::new(&debug_strings, endian);
    let debug_line = obj.section_data_by_name(".debug_line").unwrap();
